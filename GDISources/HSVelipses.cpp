...
// Estruturas e conversão de cores para o Plasma
...
// --- Efeito 4: Inversão Total (PatBlt) ---
...
int main() {
    // ShowWindow(GetConsoleWindow(), SW_HIDE); // Opcional: esconde o console
